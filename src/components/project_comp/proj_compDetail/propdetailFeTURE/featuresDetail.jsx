    ...
    <section className="bg-[#23282e] text-white py-20 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <h2 className="text-6xl font-bold mt-4 mb-6 leading-snug">
          ...
          <ul className="list-disc ml-6 text-gray-300 space-y-3 text-1xl">
