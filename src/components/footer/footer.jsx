...
export default function FooterSection() {
  return (
    <footer className="relative bg-[#2d3542] text-white py-20 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-40 bg-[url('https://daxx.lohatheme.com/wp-content/uploads/2024/02/footer-top-bg.jpg')] bg-repeat z-0" />

      <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-3 gap-8 items-start">
        {/* Left Section */}
        <div className="md:col-span-1">
          <p className="text-sm uppercase tracking-widest text-green-700 mb-4">
            <span className="inline-block w-10 h-[1px] bg-blue-500 mr-3 align-middle" />
            DEVELOPER
            <span className="inline-block w-10 h-[1px] bg-blue-500 ml-3 align-middle" />
          </p>
        ...
        <div className="md:col-span-1 flex flex-col gap-3">
          <p className="text-lg">PL No 200, Opposite Bhavnagri,</p>
          <p className="text-lg">Ring Road, Chhatrapati Nagar,</p>
          <p className="text-lg">Maharashtra 440015</p>
        ...
        <div className="md:col-span-1 flex flex-col gap-4 items-start">
          <p className="text-lg">+91 99224 40957</p>
          <p className="text-lg">princelandsngp@gmail.com</p>
